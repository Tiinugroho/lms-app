    ...
    <main class="flex-1 pb-12 pt-8 relative w-full">
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 w-full">
            <div class="mb-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    <h2 class="text-2xl font-bold text-gray-900">Tambah Data Staff Baru</h2>
                    <p class="text-sm text-gray-500 mt-1">Lengkapi profil dan tentukan hak akses sistem untuk staff.</p>
                </div>
            ...
            <div class="mb-6 bg-blue-50 border-l-4 border-blue-500 p-4 rounded-r-md shadow-sm">
                <div class="flex">
                    ...
                    <div class="ml-3"><p class="text-sm text-blue-700"><strong>Info:</strong> Password login otomatis disamakan dengan <strong>NIP / ID Pegawai</strong> saat disimpan.</p></div>
                </div>
            </div>

            <form action="{{ route('admin.staffs.store') }}" method="POST" enctype="multipart/form-data" class="bg-white shadow-sm sm:rounded-xl border border-gray-200 overflow-hidden">
                @csrf
                        ...
                        <div class="grid grid-cols-12 gap-6">
                            ...
                            <div class="col-span-12 md:col-span-6 bg-gray-50 p-4 rounded-lg border border-gray-200 mt-2 flex items-center">
                                <label class="flex items-center cursor-pointer w-max">
                                    ...
                                    <span class="ml-3 text-base text-gray-700 font-medium">Akun Aktif (Bisa login ke sistem)</span>
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-12 gap-6">
                            <div class="col-span-12 md:col-span-4">
                                ...
                                <input type="text" name="nip" value="{{ old('nip') }}" required placeholder="Wajib untuk Password" class="block w-full rounded-md border border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-base py-2.5 px-3">
                            </div>
                            ...
                            <div class="col-span-12 md:col-span-4">
                                ...
                                <input type="text" name="position" value="{{ old('position') }}" required placeholder="Contoh: Kepala Tata Usaha" class="block w-full rounded-md border border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-base py-2.5 px-3">
                            </div>
