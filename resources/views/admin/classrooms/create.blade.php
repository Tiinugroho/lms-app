    ...
    <main class="flex-1 pb-12 pt-8 relative w-full">
        ...
        <div class="mx-auto max-w-12xl px-4 sm:px-6 lg:px-8 w-full">
            <div class="mb-8">
                ...
                <p class="text-sm text-gray-500 mt-1">Lengkapi form di bawah ini untuk menambahkan data kelas.</p>
            </div>
                ...
                <form action="{{ route('admin.classrooms.store') }}" method="POST">
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name') }}" placeholder="Contoh: X IPA 1" required
                    ...
                    <div class="mt-8 flex justify-end gap-3">
                        <button type="reset" class="px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                            Reset
                        </button>
